...
export default function Header({ scroll, isMobileMenu, handleMobileMenu, isSearch, handleSearch, isOffCanvas, handleOffCanvas }: any) {
	return (
		<>
			<div>
							...
							<div className="d-flex flex-column flex-lg-row justify-content-between align-items-center">
								<div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
									<a href="tel:123456789" className="pe-4">
										...
										<span className="text-900 fs-7">+62 878-3616-7585</span>
									...
									<div className="location d-flex align-items-center">
										...
										<span className="text-900 ps-1 fs-7">Surakarta, Jawa Tengah </span>
									</div>
								</div>
								<div className="d-flex d-none d-lg-flex align-items-center justify-content-center justify-content-lg-end">
									...
									<span className="text-900 pe-3 ps-1 fs-7">Senin-Sabtu: 08:00am - 00:00pm</span>
									<a href="mailto:contact@infinia.com" className="ps-4">
										...
										<span className="text-900 ps-1 fs-7">devdreamtech20@gmail.com</span>
									</a>
								</div>
							</div>
						</div>
					...
					<nav className={`navbar navbar-expand-lg navbar-light w-100 z-999 ${scroll ? 'navbar-stick' : ''}`} style={{ position: `${scroll ? "fixed" : "relative"}`, top: `${scroll ? "0" : "auto"}`, bottom: `${scroll ? "auto" : "0"}` }}>
						<div className="container">
							<Link className="navbar-brand d-flex main-logo align-items-center" href="/">
								<img src="assets/imgs/logo/logo.png" alt="infinia" className='me-2' style={{ width: '40px' }} />
								<span>Dev_Dream</span>
							</Link>
							<Menu />
							<div className="d-flex align-items-center pe-5 pe-lg-0 me-5 me-lg-0">
								...
								<ThemeSwitch />
								<a href="https://wa.me/6287836167585?text=Halo%20Desk%20Dream%2C%20saya%20tertarik%20dengan%20jasa%20yang%20ditawarkan.%20Bolehkah%20saya%20berdiskusi%20terlebih%20dahulu%3F
