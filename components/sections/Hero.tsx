			...
			<section className="section-hero-2 position-relative fix section-padding pb-lg-0">
				<div className="container">
					<div className="row text-center position-relative z-1">
						...
						<div className="mt-8 mt-md-6 position-relative z-1 text-900">
							{/* 3D Logo Scene */}
							<Logo3D />
							...
							{/* Feature Card 3D */}
							<div className="position-md-absolute d-inline-block pt-8 pt-md-6 top-50 start-0 translate-middle-y mt-12">
								<FeatureCard3D />
							</div>
						</div>
